...
// include: /tmp/tmpyg1d865o.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'SpaecAutonomous.data';
      var REMOTE_PACKAGE_BASE = 'SpaecAutonomous.data';
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_SpaecAutonomous.data');
      }
      Module['addRunDependency']('datafile_SpaecAutonomous.data');
    ...
    loadPackage({"files": [{"filename": "/assets/Enemy.png", "start": 0, "end": 544}, {"filename": "/assets/Roket_anim.png", "start": 544, "end": 1278}, {"filename": "/assets/player.jpg", "start": 1278, "end": 8851}, {"filename": "/assets/player.png", "start": 8851, "end": 49131}], "remote_package_size": 49131});

  })();

// end include: /tmp/tmpyg1d865o.js
// include: /tmp/tmphba8al45.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmphba8al45.js
// include: /tmp/tmpqpv9l7s6.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpqpv9l7s6.js
...
function findWasmBinary() {
  return locateFile('SpaecAutonomous.wasm');
}
...
var ASM_CONSTS = {
  104006: () => { if (document.fullscreenElement) return 1; },  
 104052: () => { return Module.canvas.width; },  
 104084: () => { return parseInt(Module.canvas.style.width); },  
 104132: () => { document.exitFullscreen(); },  
 104159: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 104231: () => { if (document.fullscreenElement) return 1; },  
 104277: () => { return Module.canvas.width; },  
 104309: () => { return screen.width; },  
 104334: () => { document.exitFullscreen(); },  
 104361: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 104555: () => { return window.innerWidth; },  
 104581: () => { return window.innerHeight; },  
 104608: () => { if (document.fullscreenElement) return 1; },  
 104654: () => { return Module.canvas.width; },  
 104686: () => { return parseInt(Module.canvas.style.width); },  
 104734: () => { if (document.fullscreenElement) return 1; },  
 104780: () => { return Module.canvas.width; },  
 104812: () => { return screen.width; },  
 104837: () => { return window.innerWidth; },  
 104863: () => { return window.innerHeight; },  
 104890: () => { if (document.fullscreenElement) return 1; },  
 104936: () => { return Module.canvas.width; },  
 104968: () => { return screen.width; },  
 104993: () => { document.exitFullscreen(); },  
 105020: () => { if (document.fullscreenElement) return 1; },  
 105066: () => { return Module.canvas.width; },  
 105098: () => { return parseInt(Module.canvas.style.width); },  
 105146: () => { document.exitFullscreen(); },  
 105173: ($0) => { Module.canvas.style.opacity = $0; },  
 105211: () => { return screen.width; },  
 105236: () => { return screen.height; },  
 105262: () => { return window.screenX; },  
 105289: () => { return window.screenY; },  
 105316: () => { return window.devicePixelRatio; },  
 105352: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 105405: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 105456: () => { Module.canvas.style.cursor = 'none'; },  
 105493: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 105749: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 105800: () => { if (document.pointerLockElement) return 1; },  
 105847: () => { if (document.fullscreenElement) return 1; },  
 105893: () => { return window.innerWidth; },  
 105919: () => { return window.innerHeight; }
};
